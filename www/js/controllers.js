...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $sce, DataLoader, $rootScope, $log ) {
  ...
  $rootScope.url = 'http://ai4all.duapp.com/wp-json/wp/v2/';
...
.controller('TestCtrl', function($scope,$cordovaDevice,$cordovaCamera) {
	ionic.Platform.ready(function(){
    // will execute when device is ready, or immediately if the device is already ready.
	if(ionic.Platform.isAndroid())
		$scope.uuid=$cordovaDevice.getModel();
	else
		$scope.uuid='test';
